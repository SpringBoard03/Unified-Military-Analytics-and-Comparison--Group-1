...
**Source Retrieval:** Accessed country-level data pages from the provided list of URLs.

**Metric Extraction:** Collected key indicators including manpower strength, defense budgets, aircraft, tanks, and other equipment statistics.

**Data Parsing:** Converted webpage HTML elements into structured key–value data.

**Data Storage:** Saved the extracted records into a raw CSV dataset.
