...
- 📦 **Outputs:** `military_raw_data.csv`, `Quick Stats.pbix`, `Quick Stats.pdf`
...
📦 **Outputs:** `military_final.csv`, `Nation Overview.pbix`, `Nation Overview.pdf`
...
- 📦 **Outputs:** `Compare Powers.pbix`, `Compare Powers.pdf`

---

### Milestone 4 — Power BI Dashboard (Coalition Builder)

> **Objective:** Build an interactive coalition comparison interface to assemble and evaluate multi-nation coalitions.

📄 **Output:** `Coalition Builder.pbix`, `Coalition Builder.pdf`
